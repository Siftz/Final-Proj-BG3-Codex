    ...
    LEFT JOIN descriptions d ON i.description_id = d.id";
        ...
        while (reader.Read())
        {
            var item = new Item
            {
                ...
                Rarity = new Rarity
                {
                    RarityName = reader.IsDBNull(reader.GetOrdinal("rarity_name"))
                        ? null
                        : reader.GetString(reader.GetOrdinal("rarity_name"))
                },
                Property = new Property
                {
                    PropertyName = reader.IsDBNull(reader.GetOrdinal("property_name"))
                        ? null
                ...
                Act = new Act
                {
                    ActName = reader.IsDBNull(reader.GetOrdinal("act_name"))
                        ? null
                        : reader.GetString(reader.GetOrdinal("act_name"))
                },
                Description = new Description
                {
                    Text = reader.IsDBNull(reader.GetOrdinal("description"))
                        ? null
